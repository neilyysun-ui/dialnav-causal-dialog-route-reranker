...
data. A Guide goal confirmation is encoded as answer text; the Navigator stops
by matching that received text, without a separate signal. The system executes
one causal trajectory, with no replay or episode selector.
